...
/**
 * <p>Java 8 implementation of the {@link MultiKeyMap}. It behaves like a regular generic Map with the
 * additional ability of getting its values by any combination of partial keys. 
 * <p>{@link MultiKeyMaps}'s static factory methods are main entries to this package functionality.
 * Use {@link MultiKeyMaps#newMultiKeyMap()} to get an instance of the default implementation.
 * In addition, one can create  a new {@link MultiKeyMap} based on the data copied from the provided map using
